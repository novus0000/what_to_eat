...
function showFoodList() {
  ...
  // if (document.getElementsByName('mode')[0].value=='USERNAME'){
  //   var title = ["FOOD"]
  // }else{
  var title= ["FOOD","Q1","Q2","Q3","Q4","Q5","Q6","Q7", "NAME", "DATE"]
 //}
  // fetch("http://gyrjs07.dothome.co.kr/what_to_eat/foodlist.php?mode="+mode+"&"+"search="+search)
  fetch("http://gyrjs07.dothome.co.kr/what_to_eat/food_list_by_username.php")
...
// Append table structure to mounting point
 if ( mountingPoind.hasChildNodes() ) { mountingPoind.removeChild( mountingPoind.firstChild );}
